...
<html lang="es">
  <head>
    ...
    <style>
      ...
      :root {
        /* Marca — heredada de library/brand/brand.md */
        --tinta: #1B1A17;
        --papel: #F2EBDD;
        --acento: #B89968;

        /* Zona segura 9:16 (Reels, la estricta) — ver style/safe_zones.md */
        --safe-top: 270px;
        --safe-bottom: 670px;   /* Story-only: 380px */
        --safe-x: 65px;
        --safe-right: 120px;
      }
...
Números canónicos 2026 (fuente: `style/safe_zones.md`; 9:16 = zona de Reels,
la estricta — Story-only baja `--safe-bottom` a 380px):

| | 9:16 | 4:5 | 1:1 | 16:9 |
|---|---|---|---|---|
| `data-width` / `data-height` | 1080 / 1920 | 1080 / 1350 | 1080 / 1080 | 1920 / 1080 |
| `--safe-top` | 270px | 64px | 64px | 54px |
| `--safe-bottom` | 670px | 64px | 64px | 120px |
| `--safe-x` | 65px | 100px | 140px | 96px |
| `--safe-right` | 120px | 100px | 140px | 96px |
