# Ejemplo GOOD — POV novio desesperado encuentra la faja térmica 30s (split en 2 clips Kling Pro + lipsync)
...
- **Beat clave entre clips:** Clip 1 termina con el actor sosteniendo el celular (encontrado en IG); Clip 2 arranca con el actor sosteniendo la faja física (ya la tiene). El "salto temporal" es narrativamente claro.
- Prompts: Clip 1 = 2217 chars, Clip 2 = 2141 chars (ambos bajo cap 2500, verificados con `wc -c`).

---

# Paquete de video — Novio desesperado encuentra la faja térmica (30s, 2 clips Kling)

## 1. Análisis de escena
- **Tipo de contenido:** ad POV humorístico (novio buscando regalo, encuentra la faja, "clavó la sorpresa")
- **Sujeto principal:** ambos — hombre argentino ~30 + la faja eléctrica rosa pastel (marca anonimizada)
...
- **Clip 1 (0–15s):** Setup → hook (día 5 de búsqueda) → flashback de fracasos → encuentra la faja en Instagram
...
- **Continuidad inter-clip:** mismo wardrobe + mismo setting + misma luz + mismo color grading. Transición narrativa lógica: termina Clip 1 con celular en mano (encontrado en IG) → arranca Clip 2 con la faja física (ya la regaló).
- **Aspect ratio:** 9:16
...
Differences from Clip 1: instead of the smartphone, he is now holding the heating belt device in his right hand at mid-chest height, presented toward the camera. The belt is a pastel-pink rounded rectangular plastic body with a small circular dark LCD display in the center (off, dark), a small pink brand wordmark on the front face below the display, and a light gray adjustable fabric strap dangling from one end. His left hand is relaxed at his side. His expression: animated, eyebrows raised, mouth open mid-speech, eyes on the camera with a "let me explain this" energy.

Framing unchanged: same medium close-up from mid-chest up, eye-level, 9:16 vertical, eyes upper third, the belt visible mid-frame in front of his torso. Same iPhone 15 Pro photorealistic style, same DOF, same skin texture, same color grading.
```

### Clip 2 — Last frame
```
Same 30-year-old Argentine man, same hair stubble t-shirt setting and lighting as in Clip 2 first frame. The heating belt is still in the picture but now held lower, against the left side of his chest with his left hand (cradled, no longer presented forward). Same pastel-pink body, same circular LCD, same brand wordmark.

Differences from Clip 2 first: (a) the belt switched from right hand presented to left hand held against chest; (b) his right hand now extends in front of his torso with index finger pointing downward in a clear "link below" gesture; (c) his expression closed-lip smug half-smile, slight raised eyebrow, eyes locked on the camera with a "trust me on this" look.
...
```
**Qué cambia respecto a Clip 2 first:** la faja pasa de presentada adelante a apoyada en el pecho; mano derecha apunta hacia abajo (gesto link); expresión cierra con sonrisa pícara.
...
Holding the pastel-pink heating belt in right hand at mid-chest as shown in Clip 2 first frame reference (pink rounded body, small circular LCD, brand wordmark, gray fabric strap dangling).

From 0-7s: he holds the belt presented forward, slightly rotates it 15 degrees back and forth to show it. At 2s small "tired collapsed" gesture with his free left hand (palm down low, like "two days in bed"). At 4s he taps the surface of the belt twice with his left index finger (gesture "calor"), at 5s makes a tiny vibrating motion with left fingers (gesture "vibración"). At 6.5s a small "como si nada" smirk with one eyebrow up. Lips move in minimal conversational articulation synced to off-camera voice throughout (no native audio).

From 7-12s: he lowers the belt to chest level cradled in left hand. At 8s a small head nod ("regalé"). At 9s another nod ("probó"). At 10s eyebrows raise and a half-amused smile starts ("funcionó"). At 11s eyebrows raise higher with mouth open in mock-surprise on the beat of "LO RE USA". Lips continue minimal articulation to off-camera voice.
...
- SFX (diegetic): soft cotton t-shirt fabric shifts; faint finger taps on the plastic body of the belt at 4s and 5s.
...
- **La faja en Clip 2 puede cambiar de color de rosa** vs lo que se ve en el celular en Clip 1 last. **Mitigación:** ambos prompts usan "pastel-pink rounded body". Si drifta, regenerar Clip 2.
...
- **El gesto de "calor y vibración" en Clip 2 (4-5s) puede salir confuso** — el actor solo toca el producto. **Mitigación:** las direcciones son específicas ("taps the belt twice with left index finger" / "tiny vibrating motion with left fingers"). Si igual sale ambiguo, agregar texto overlay "calor + vibración" en post.

## 9. Flujo de producción
1. **Nano Banana ×4:** generar Clip 1 first, Clip 1 last, Clip 2 first, Clip 2 last. Subir la imagen real del producto como referencia visual junto con los prompts de Clips 2.
