...
`all-videos` + 1 packshot de `assets/products/`.
...
> "Tengo los 4 clips del sérum que generamos la semana pasada en
> `exports/videos/2026-08-18_serum-noche_v1/`. Armame un reel."
...
Marca del `CLAUDE.md`: papel `#F2EBDD`, tinta `#1B1A17`, acento `#8FA086`,
tipografía sans geométrica (`assets/fonts/`). Tono: técnico y sobrio, voseo, sin
exclamaciones.
...
### 8. Marca real
La fuente sale de `assets/fonts/`, copiada al proyecto y declarada con
`font-display: block`. La paleta sale del `CLAUDE.md`, no de la impresión que dio
el clip.
