...
> **Cómo usarlos**: pegá cada prompt en nano banana junto con la imagen de referencia del producto (la misma para los N slides). Los prompts están numerados — generá uno por uno en el orden indicado.
