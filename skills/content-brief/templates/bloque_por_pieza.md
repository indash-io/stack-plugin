...
> **Fuente única de este contrato.** La copia de `skills/new-brief/reference/bloque-por-pieza.md`
> es un espejo para que la skill de ejecución (que se siembra standalone) lo tenga a mano:
