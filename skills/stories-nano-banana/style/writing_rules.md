...
Reglas para los **dos tipos de escritura** que produce la skill: el **copy on-image** (texto que va dentro de cada story) y los **prompts** a nano banana (la parte cinematográfica que pega el user).
...
### A1. Brevedad
- Máximo **6-8 palabras por story**. Idealmente 3-6.
- Stories tienen 5-15 segundos de auto-advance — el usuario tiene que leer al instante.
- Si necesitás 9+ palabras, replanteá: probablemente estás metiendo dos ideas en una story.
...
- Si los pidió: máximo **uno por story**, y solo cuando aporta semánticamente, nunca decorativo.

### A4. Cero exclamaciones
- Salvo arquetipo Promo, y máximo en uno o dos storys.
...
- Si el user pide bilingüe → confirmá idioma por story.
...
El copy del story va **siempre entre comillas dobles** dentro del prompt.
...
### B10. Consistencia entre prompts de la secuencia
...
Si el story incluye persona, aplicá las 7 reglas de `prompt_engineering.md` Ley 6:
1. Edad concreta
...
### B13. Zona segura de UI obligatoria
Cada prompt debe especificar que el texto on-image vive **dentro de la zona segura** (entre 14% y 85% del alto vertical), evitando los bordes superior e inferior tapados por la UI nativa de Instagram Stories.
...
- ✅ "Brief creativo", "Story-by-story", "Prompts para Nano Banana"
- ❌ "Creative brief", "Stories", "Prompts"

### C2. Sin preámbulo ni cierre conversacional
- Empezá directo con `# Stories: [Producto]`.
...
Copy on-image: máximo 6-8 palabras, específico, con datos crudos, sin marketing-speak, sin emojis, verbos en activa, paralelismo en listicles, CTA accionable atado a sticker Link. Prompts: prosa narrativa en español, anclaje a imagen primero, nunca describir el producto desde cero, vocabulario fotográfico técnico, texto entre comillas dentro de zona segura (14%-85%), cero prompts negativos, cierre 9:16 obligatorio, personas dirigidas con las 7 disciplinas. Texto del agente: directo, sin emojis, sin exclamaciones, sin AI-speak, encabezados en español. Sticker por story sugerido en el shot list, siempre.
