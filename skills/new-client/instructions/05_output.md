...
Cerrás el onboarding mostrando lo que quedó creado y los próximos pasos. Acá **sí** hablás con el user.

---

## Qué mostrás

1. **El árbol creado** — listá la estructura de carpetas del cliente tal como quedó en disco (un árbol corto, legible).
...
## Próximos pasos (handoff a las skills de contenido)
...
1. **Mostrá el árbol real**, no uno inventado: listá lo que efectivamente creaste.
2. **Sé honesto con los pendientes.** Si los productos no se trajeron, decilo claro y por qué.
3. **Handoff concreto**: nombrá las skills que siguen y qué inputs piden.
4. Tono rioplatense, breve. Sin párrafos de relleno.
