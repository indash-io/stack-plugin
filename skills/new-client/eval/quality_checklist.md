...
- [ ] Logos → `assets/logos/`, tipografías → `assets/fonts/`, brand kit crudo/PDF → `assets/brand-kit/`. Cada cosa en su carpeta, nada mezclado.
- [ ] Si la marca no estaba en Indash, ofrecí al user pasar los archivos (PDF/logos/fuentes) y los guardé donde corresponde.
- [ ] Escribí `assets/brand-kit/brand.md` (narrativa) y `assets/brand-kit/brand-kit.md` (resumen estructurado), coherentes con el `CLAUDE.md`.
...
- [ ] `assets/products/index.md` sigue `templates/product_index.md`.
...
- [ ] Expliqué cómo seguir: qué skill disparar (`carruseles` / `stories-nano-banana`) y qué inputs pide.
